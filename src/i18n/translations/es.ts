...
export const es: Translations = {
  ...
  inputs: {
    ...
    housing: {
      ...
      mortgageTypeFixed: 'Fija',
      mortgageTypeVariable: 'Variable',
      mortgageRate: 'Tasa Hipotecaria',
      mortgageTerm: 'Plazo de Hipoteca',
      initialFixedPeriod: 'Período Fijo Inicial',
      initialFixedPeriodHint: 'Años a tasa fija antes de pasar a variable',
      initialFixedRate: 'Tasa Fija Inicial',
      initialFixedRateHint: 'Tasa durante el período fijo inicial',
      variableSpread: 'Diferencial sobre Euríbor',
      variableSpreadHint: 'Margen añadido al índice Euríbor',
      euriborForecast: 'Euríbor Esperado',
      euriborForecastHint: 'Tasa Euríbor media prevista',
