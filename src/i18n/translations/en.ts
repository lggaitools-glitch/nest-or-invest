...
export const en: Translations = {
  ...
  inputs: {
    ...
    housing: {
      ...
      mortgageTypeFixed: 'Fixed',
      mortgageTypeVariable: 'Variable',
      mortgageRate: 'Mortgage Rate',
      mortgageTerm: 'Mortgage Term',
      initialFixedPeriod: 'Initial Fixed Period',
      initialFixedPeriodHint: 'Years at the fixed rate before switching to variable',
      initialFixedRate: 'Initial Fixed Rate',
      initialFixedRateHint: 'Rate during the initial fixed period',
      variableSpread: 'Spread over Euribor',
      variableSpreadHint: 'Margin added to the Euribor index',
      euriborForecast: 'Expected Euribor',
      euriborForecastHint: 'Forecasted average Euribor rate',
