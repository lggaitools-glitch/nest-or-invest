...
export interface Translations {
  ...
  inputs: {
    ...
    housing: {
      ...
      mortgageType: string;
      mortgageTypeFixed: string;
      mortgageTypeVariable: string;
      mortgageRate: string;
      mortgageTerm: string;
      initialFixedPeriod: string;
      initialFixedPeriodHint: string;
      initialFixedRate: string;
      initialFixedRateHint: string;
      variableSpread: string;
      variableSpreadHint: string;
      euriborForecast: string;
      euriborForecastHint: string;
      monthlyRent: string;
